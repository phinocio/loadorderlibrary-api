...
'sanctum.csrf-cookie','auth.register','auth.login','auth.logout','storage.local',);
...
'SESSION_PATH','SESSION_DOMAIN','BROADCAST_DRIVER','FILESYSTEM_DISK','QUEUE_CONNECTION',
...
'AWS_SECRET_ACCESS_KEY','AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','R2_ACCESS_KEY_ID',
'R2_SECRET_ACCESS_KEY','R2_REGION','R2_ENDPOINT','R2_USE_PATH_STYLE_ENDPOINT','R2_BUCKET_UPLOADS',
'VITE_APP_NAME',);
