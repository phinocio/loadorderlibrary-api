...
'sanctum.csrf-cookie','register','login','logout','storage.local',);
...
'APP_PORT','SANCTUM_STATEFUL_DOMAINS','FRONTEND_URL','APP_LOCALE','APP_FALLBACK_LOCALE',
...
'AWS_USE_PATH_STYLE_ENDPOINT','R2_ACCESS_KEY_ID','R2_SECRET_ACCESS_KEY','R2_REGION','R2_ENDPOINT',
'R2_BUCKET_UPLOADS','VITE_APP_NAME',);
